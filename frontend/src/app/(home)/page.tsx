  ...
  return (
    <Box>
      ...
      <Typography textAlign={'center'} variant={'h4'}>
        ...
        {!countryParam && !categoryParam && !ingredientParam && 'No filters applied.'}
      </Typography>
      <List>
        {meals.map((el: Meal) => (
          <ListItem
            ...
            {el?.strMealThumb ? <Image height={100} width={100} alt={'Meal image'} src={el.strMealThumb}/> :
              <ImageNotSupportedIcon/>}
            <ListItemText sx={{...listTextStyle, marginLeft: '30px'}} primary={<Typography variant={'h5'}>{el.strMeal}</Typography>}/>
          </ListItem>
        ))}
      </List>
    </Box>
